     ...
     <?php
        ...
        ?>
                <form action="../shopping_cart/cart.php" method="POST" role="form">
                    <legend><div style="margin-left: 40%;margin-top: 5%">
                        CHI TIẾT SẢN PHẨM
                    </div></legend>
                    <div class="row = 12">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="margin: 30px">
                            <div class="form-group" >                     
                                <p class="image-effect"><img src=" <?php echo $linkImage.$row['Images'] ?>" width = 200px></p>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            ...
                            <a href="../web.php"><button type="button"  class="btn btn-default">Quay lại</button></a>
