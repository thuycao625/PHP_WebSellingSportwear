	...
	<div class="page-header">
		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
			<div class="text-right">
				<a href="file:///C:/Web%20frontend/projectweb/code/thanhtoan.html"><span class="glyphicon glyphicon-shopping-cart"></span>Giỏ hàng</a>
			</div>				
		</div>
	</div>
	<div class="logo">
	...
	<div class="container">
		<div class="menu">
			<div class="topnav" id="myTopnav">
			    ...
			    <a href="file:///C:/Web%20frontend/projectweb/code/gioithieu.html">GIỚI THIỆU</a>
			    <a href="file:///C:/Web%20frontend/responsive.html#sp">SẢN PHẨM</a>
			    <a href="file:///C:/Web%20frontend/projectweb/code/thanhtoan.html">THANH TOÁN</a>
			    <a href="file:///C:/Web%20frontend/projectweb/code/lienhe.html">LIÊN HỆ</a>
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-9">
				<div class="gt">
					<h3>Liên hệ</h3>
					Cơ sở 1: Số 101B Lê Hữu Trác,  Sơn Trà, DN<br>

					Cơ sở 2: Số 99 Tô Hiến Thành,  Sơn Trà, DN.<br>

					Hotline: 0347248085 – 02363585858<br>

					Email: sportwear@gmail.com<br>
					<img src="../Image/vicb.jpg" width="400" height="150">
					<img src="../Image/agri.jpg" width="400" height="150">
				</div>
			</div>
  		</div>
