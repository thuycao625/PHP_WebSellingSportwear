...
<body>
	...
	<div class="container">
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<label style="color: red ;"><h1>GIÀY THỂ THAO</h1></label>
		</div>
		...
		<div class="row">
		    ...
		    $sql = "SELECT * FROM products WHERE category_id = 6 limit 4";
		    $linkImage = '../Image/';
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<label style="color: red ;"><h1>ĐỒ BÓNG ĐÁ</h1></label>
		</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<label style="color: red ;"><h1>ĐỒ BÓNG CHUYỀN</h1></label>
		</div>
